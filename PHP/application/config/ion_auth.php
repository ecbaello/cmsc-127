...
*/
$config['tables']['users']           = 'fin_users';
$config['tables']['groups']          = 'fin_groups';
$config['tables']['users_groups']    = 'fin_users_groups';
$config['tables']['login_attempts']  = 'fin_login_attempts';
