...
class MY_Archpcfmodel extends MY_Archarraymodel
{
	...
	*/
	public function __construct()
	{
		...
		$this->registerCategoryTable('General Archive','arch_pcf_general_model');
        $this->registerCategoryTable('Smile Train Archive','arch_pcf_smiletrain_model');
        $this->registerCategoryTable('Cataract Archive','arch_pcf_cataract_model');
	}
